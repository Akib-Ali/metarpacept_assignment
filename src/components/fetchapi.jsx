    ...
    const rawdata = [
        {
          ...
          "ImageUrl": "https://imgd-ct.aeplcdn.com/370x208/n/cw/ec/106257/venue-exterior-right-front-three-quarter-2.jpeg?isig=0&q=75",
...
return(
    ...
    <div className="container">
        ...
        {rawdata.map((elem,index)=>{

            return(

            <div style={{ height:"500px", width:"410px", backgroundColor:"white", border:"1px solid grey"}}>
            <img src={elem.ImageUrl}/>
            <h1 style={{fontSize:"25px",  fontWeight:"700px"}} >{elem.Name}</h1>
            <p>{elem.ShortDesc}</p>
            <button style={{border:"1px solid grey", marginTop:"15px", width:"60px"}}>View</button>
